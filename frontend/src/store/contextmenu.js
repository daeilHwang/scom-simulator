...
function buildContextmenu(menu, left, top, loc) {
    ...
    menu.forEach(d => {
        ...
        if (typeof d === 'object') {
            ...
            if (Object.prototype.hasOwnProperty.call(d, 'sub')) {
                text.textContent += " ->"
            ...
            if (Object.prototype.hasOwnProperty.call(d, 'extraText')) {
            ...
            if (Object.prototype.hasOwnProperty.call(d, 'onclick')) {
                item.addEventListener('click', e => d.onclick(e, removeContextMenu));
            }
        }
        else {
            if (d === 'divider') {
...
export function createContextmenu(ele, menu, type) {
    let elem;
